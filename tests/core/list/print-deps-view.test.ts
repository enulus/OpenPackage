...
describe('printDepsView', () => {
  it('excludes workspace root names from all scopes in dependency tree', () => {
  ...
  it('shows correct dependency count after filtering workspace roots', () => {
